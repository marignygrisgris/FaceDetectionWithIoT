...
using CameraFaceDetection.Common;
...
namespace CameraFaceDetection
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        Uri uploadAddress = new Uri("http://iotfacedetection.azurewebsites.net/api/FaceDetection/FaceUpload?DeviceId=3d16334ca04a412388bae34d0dbf300f");
